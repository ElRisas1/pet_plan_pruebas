...
class PantallaMascota extends StatefulWidget {
  ...
  // Constructor
  const PantallaMascota({super.key, required this.nombreMascota,required this.imagenMascota, required String title});
  ...
  Widget contenido(){
    return Stack(
      children: [
        ...
        Padding(
          padding: const EdgeInsets.only(top: 90, left: 170 ), // Ajusta el espacio superior para evitar que se solape con el AppBar
          child: Text(
            ...
            child: Material(
              ...
              child: Container(
                ...
                child: InkWell(
                  ...
                  child: CircleAvatar(
                    radius: 50,
                    backgroundImage: AssetImage(widget.imagenMascota), // Usa la imagen pasada
                  ),
                  ),
                ),
              ),
